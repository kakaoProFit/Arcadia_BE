...
public class ReplyController {
    ...
    // public ResponseEntity<CommentWriteResponse> commentWrite(@PathVariable Long
    // boardId,
    ...
    // String nextUrl = "/boards/" + boardService.getCategory(boardId) + "/" +
    // boardId;
    ...
    // public ResponseEntity<CommentWriteResponse> editComment(@PathVariable Long
    // commentId,
    // @RequestBody CommentCreateRequest req,
    // Authentication authentication) {
    // Long boardId = commentService.editComment(commentId, req.getBody(),
