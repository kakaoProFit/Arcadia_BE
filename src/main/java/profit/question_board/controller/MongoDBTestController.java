package profit.question_board.controller;
...
import profit.question_board.service.MongoDBTestService;
...
public class MongoDBTestController {
    ...
    public String findUserData(@RequestParam String title) {
        return mongoDBTestService.selectBoard(title);
    }
